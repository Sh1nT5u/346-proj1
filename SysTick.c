...
// Time delay using busy wait. Change to wait 0.5s. Multiply og time by 5 (10ms -> 0.1s)
	// Param - delay: amount of times to wait the designated wait time in ms 
// This assumes 50 MHz system clock.
void SysTick_Wait05s(unsigned long delay){
    unsigned long i;
    for(i=0; i<delay; i++){
